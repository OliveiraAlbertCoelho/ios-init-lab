 ...
 */
var someLocation = GPS()
print(someLocation)

/*:
 Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
 */
someLocation.latitude = 51.514004
someLocation.longitude = 0.125226
print(someLocation)
...
favoriteBook.author = "mashashi kishimoto"
favoriteBook.pages = 940
favoriteBook.price = 10.00
favoriteBook.title = "One piece"
print(favoriteBook)
